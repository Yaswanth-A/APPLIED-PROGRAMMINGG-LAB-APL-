...
def spectrum_plot(lim,n,f,t_=0,show_ = True,t_lims = False,windowing= False,xlim1=10,title1 = r"Spectrum of $\sin\left(\sqrt{2}t\right)$",xlabel1 = r"$\omega$",ylabel1= r"$|Y|$", ylabel2 = r"Phase of $Y$",savename = "abc.png"):
    if(t_lims):
        t = t_
    else:
...
#Question 1
examples()  #Given example codes

#Question 2
#Spectrum of cos^3 unwindowed
a,b = spectrum_plot(4*pi,64*4,cos3,xlim1= 3,windowing=False, title1 = r"Spectrum of $cos^3(w_0t)$",savename = '10-8.png')
#Spectrum of cos^3 windowed 
a,b = spectrum_plot(4*pi,64*4,cos3,xlim1= 3,windowing=True, title1 = r"Spectrum of $cos^3(w_0t)$",savename = '10-8.png')

#Question 3
#Digital Spectrum of cos(wt+delta) windowed to estimate w, delta
w,Y = spectrum_plot(pi,128,cosine,xlim1= 3,windowing=True, title1 = r"Spectrum of $cos(w_0t + \delta)$",savename = '10-8.png')

#calculating w and delta
est_omega(w,Y)
est_delta(w,Y)

#Question 4
#Spectrum of cos(wt+delta) after adding noise

w,Y = spectrum_plot(pi,128,noisycosine,xlim1= 3,windowing=True, title1 = r"Spectrum of $cos(w_0t + \delta)$")
...
#Spectrum of chirped signal with windowing
w,Y = spectrum_plot(pi,1024,chirp,xlim1= 60,windowing=True, title1 = r"Spectrum of chirp function")
#Spectrum of chirped signal without windowing
w,Y = spectrum_plot(pi,1024,chirp,xlim1= 60,windowing=False, title1 = r"Spectrum of chirp function")

#Question 6
#Plotting surface plot to see how freq of signal varies with time
...
for i in range(len(t_arrays)):
    w,Y = spectrum_plot(lim = 10,t_ = t_arrays[i],t_lims=True,n = 64,f = chirp,xlim1= 60,windowing=False, title1 = r"Spectrum of chirp function",show_ = False)
    Y_mags[i] =  abs(Y)
    Y_angles[i] =  angle(Y)

#Plotting array as surface plot
fig = plt.figure()
